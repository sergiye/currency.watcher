...
namespace currency.watcher {
  ...
  public static class ColorScheme {
    ...
    private static Color ColorGreater => !Theme.Current.WindowTitlebarFallbackToImmersiveDarkMode ? Color.FromArgb(0xF7CF18) : Color.FromArgb(0xBF652E);
    private static Color ColorLower => !Theme.Current.WindowTitlebarFallbackToImmersiveDarkMode ? Color.FromArgb(0x8AB1F2) : Color.FromArgb(0x2170CF);
